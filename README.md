...
**A web application that converts speech to text in real-time using the Web Speech API.**
Ideal for transcribing meetings, notes, or any spoken content directly in your browser.

🔗 **[Live Demo](https://aurelieraout.com/speech-to-text/index.html)**
📂 **Repository**: [GitHub - Lilousound/speech-to-text](https://github.com/Lilousound/speech-to-text)
